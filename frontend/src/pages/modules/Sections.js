...
const Sections = () => {
    ...
    return <RegistryPage moduleKey="sections" config={config} datasets={datasets} lookups={lookups} fetchData={fetchData} saving={saving} setSaving={setSaving} readiness={readiness} />;
};
