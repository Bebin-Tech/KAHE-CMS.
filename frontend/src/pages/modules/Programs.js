...
const Programs = () => {
    ...
    return <RegistryPage moduleKey="programs" config={config} datasets={datasets} lookups={lookups} fetchData={fetchData} saving={saving} setSaving={setSaving} readiness={readiness} />;
};
