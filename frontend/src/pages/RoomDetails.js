...
const RoomDetails = () => {
    ...
    if (loading) return <div className="p-10 text-center font-bold text-gray-500 animate-pulse">LOADING DETAILS...</div>;
        ...
        <div className="p-10 bg-gray-50 min-h-screen">
            <div className="max-w-6xl mx-auto">
                <button
                    ...
                    className="mb-8 flex items-center text-indigo-600 font-black hover:bg-indigo-50 px-4 py-2 rounded-xl transition"
                >
